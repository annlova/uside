...
file(GLOB_RECURSE src_file_list RELATIVE ${src_dir} ${src_dir}/*)
...
foreach( each_file ${src_file_list} )
    ...
    if(NOT EXISTS ${destination_file})
        ...
        if(NOT ${source_timestamp} STREQUAL ${destination_timestamp} AND ${source_file} IS_NEWER_THAN ${destination_file})
            get_filename_component(destination_dir ${destination_file} DIRECTORY)
            file(COPY ${source_file} DESTINATION ${destination_dir})
            message("Updating:")
            message("    ${source_timestamp} ${source_file}")
...
file(GLOB_RECURSE dst_file_list RELATIVE ${dst_dir} ${dst_dir}/*)

foreach( each_file ${dst_file_list} )
    set(destination_file "${dst_dir}/${each_file}")
    set(source_file "${src_dir}/${each_file}")
    file(TIMESTAMP ${destination_file} destination_timestamp)
